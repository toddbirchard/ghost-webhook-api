...
class GithubPr:
    """Newly created Github pull request."""

    # fmt: off
    id: str = Field(None, example=1701068295)
    url: str = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320")
    node_id = Field(None, example="PR_kwDODp9lBM5lZD4H")
    html_url = Field(None, example="https://github.com/toddbirchard/blog-webhook-api/pull/320")
    diff_url = Field(None, example="https://github.com/toddbirchard/blog-webhook-api/pull/320.diff")
    patch_url = Field(None, example="https://github.com/toddbirchard/blog-webhook-api/pull/320.patch")
    issue_url = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/320")
    number = Field(None, example=320)
    state = Field(None, example="open")
    locked = Field(None, example=False)
    title = Field(None, example="Bump aiohttp from 3.9.1 to 3.9.2")
    body = Field(None, example="Bumps [aiohttp](https://github.com/aio-libs/aiohttp) from 3.9.1 to 3.9.2.")
    created_at = Field(None, example="2024-01-30T00:26:26Z")
    updated_at = Field(None, example="2024-01-30T00:26:49Z")
    closed_at = Field(None, example=None)
    merged_at = Field(None, example=None)
    merge_commit_sha = Field(None, example="d5da67d43a36c981d9159007d91c371506b08ca8")
    assignee = Field(None, example=None)
    assignees = Field(None, example=[])
    requested_reviewers = Field(None, example=[])
    requested_teams = Field(None, example=[])
    milestone = Field(None, example=None)
    draft = Field(None, example=False)
    commits_url = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320/commits")
    review_comments_url = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320/comments")
    review_comment_url = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/comments{/number}")
    comments_url = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/320/comments")
    statuses_url = Field(None, example="https://api.github.com/repos/toddbirchard/blog-webhook-api/statuses/56e8fc41369d8f6b95c6ab7a206c69cd12bab916")
    author_association = Field(None, example="CONTRIBUTOR")
    auto_merge = Field(None, example=None)
    active_lock_reason = Field(None, example=None)
    merged = Field(None, example=False)
    mergeable = Field(None, example=True)
    rebaseable = Field(None, example=True)
    mergeable_state = Field(None, example="unstable")
    merged_by = Field(None, example=None)
    comments = Field(None, example=0)
    review_comments = Field(None, example=0)
    maintainer_can_modify = Field(None, example=False)
    commits = Field(None, example=1)
    additions = Field(None, example=78)
    deletions = Field(None, example=78)
    changed_files = Field(None, example=1)
    # fmt: on

    class Config:
        json_schema_extra = {
            "url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320",
            "id": 1701068295,
            "node_id": "PR_kwDODp9lBM5lZD4H",
            "html_url": "https://github.com/toddbirchard/blog-webhook-api/pull/320",
            "diff_url": "https://github.com/toddbirchard/blog-webhook-api/pull/320.diff",
            "patch_url": "https://github.com/toddbirchard/blog-webhook-api/pull/320.patch",
            "issue_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/320",
            "number": 320,
            "state": "open",
            "locked": False,
            ...
            "labels": [
                {
                    ...
                    "url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/labels/dependencies",
                    "name": "dependencies",
                    "color": "0366d6",
                    "default": False,
            ...
            "milestone": None,
            "draft": False,
            "commits_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320/commits",
            "review_comments_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320/comments",
            "review_comment_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/comments{/number}",
            "comments_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/320/comments",
            "statuses_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/statuses/56e8fc41369d8f6b95c6ab7a206c69cd12bab916",
            "head": {
                ...
                "repo": {
                    ...
                    "full_name": "toddbirchard/blog-webhook-api",
                    "private": False,
                    "owner": {
                        "login": "toddbirchard",
                        "id": 2747442,
                    ...
                    "html_url": "https://github.com/toddbirchard/blog-webhook-api",
                    "description": "📑 🎛️ API to automate optimizations for self-hosted blogging platforms.",
                    "fork": False,
                    "url": "https://api.github.com/repos/toddbirchard/blog-webhook-api",
                    "forks_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/forks",
                    "keys_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/keys{/key_id}",
                    "collaborators_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/collaborators{/collaborator}",
                    "teams_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/teams",
                    "hooks_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/hooks",
                    "issue_events_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/events{/number}",
                    "events_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/events",
                    "assignees_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/assignees{/user}",
                    "branches_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/branches{/branch}",
                    "tags_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/tags",
                    "blobs_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/git/blobs{/sha}",
                    "git_tags_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/git/tags{/sha}",
                    "git_refs_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/git/refs{/sha}",
                    "trees_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/git/trees{/sha}",
                    "statuses_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/statuses/{sha}",
                    "languages_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/languages",
                    "stargazers_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/stargazers",
                    "contributors_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/contributors",
                    "subscribers_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/subscribers",
                    "subscription_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/subscription",
                    "commits_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/commits{/sha}",
                    "git_commits_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/git/commits{/sha}",
                    "comments_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/comments{/number}",
                    "issue_comment_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/comments{/number}",
                    "contents_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/contents/{+path}",
                    "compare_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/compare/{base}...{head}",
                    "merges_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/merges",
                    "archive_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/{archive_format}{/ref}",
                    "downloads_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/downloads",
                    "issues_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues{/number}",
                    "pulls_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls{/number}",
                    "milestones_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/milestones{/number}",
                    "notifications_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/notifications{?since,all,participating}",
                    "labels_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/labels{/name}",
                    "releases_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/releases{/id}",
                    "deployments_url": "https://api.github.com/repos/toddbirchard/blog-webhook-api/deployments",
                    "created_at": "2020-03-06T04:07:25Z",
                    "updated_at": "2024-01-14T00:01:00Z",
                    "pushed_at": "2024-01-30T00:26:27Z",
                    "git_url": "git://github.com/toddbirchard/blog-webhook-api.git",
                    "ssh_url": "git@github.com:toddbirchard/blog-webhook-api.git",
                    "clone_url": "https://github.com/toddbirchard/blog-webhook-api.git",
                    "svn_url": "https://github.com/toddbirchard/blog-webhook-api",
                    "homepage": "",
                    "size": 3358,
                    "stargazers_count": 9,
                    "watchers_count": 9,
            ...
            "_links": {
                "self": {"href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320"},
                "html": {"href": "https://github.com/toddbirchard/blog-webhook-api/pull/320"},
                "issue": {"href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/320"},
                "comments": {"href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/issues/320/comments"},
                "review_comments": {
                    "href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320/comments"
                },
                "review_comment": {
                    "href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/comments{/number}"
                },
                "commits": {"href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/pulls/320/commits"},
                "statuses": {
                    "href": "https://api.github.com/repos/toddbirchard/blog-webhook-api/statuses/56e8fc41369d8f6b95c6ab7a206c69cd12bab916"
                },
            },
